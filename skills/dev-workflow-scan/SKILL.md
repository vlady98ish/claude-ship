...
description: |
  ...
  Usage: /dev-workflow-scan
  Also triggered by /dev-workflow-init after stack detection.
...
> Auto-generated by /dev-workflow-scan on {date}. Review and customize.
...
## Integration With /dev-workflow-init

When init detects the stack and installs skills, it can auto-run scan:

```
After Step 9 (Create Starter Files) in dev-workflow-init:
  AskUserQuestion:
